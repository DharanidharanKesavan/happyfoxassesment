...
//Here AppPage class is in another project, cant be extend
public class SupportPortalPage extends AppPage{
	...
	public void navigateToHappyFoxSupportPortalURL(String url) {
		//driver needed to be declared or must be imported from another class
		this.driver.get(url);
	}
	...
	public AdminPortalTest2ndPage clickCreateTicket()
	 {
		   CreateTicket.click();
		   //cannot declare driver variable here
		   return new AdminPortalTest2ndPage(driver);
	 }
	
	//unnecessary sleep condition
